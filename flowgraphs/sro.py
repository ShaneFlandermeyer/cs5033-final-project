...
# GNU Radio version: v3.10.0.0git-553-g59d04f4a
...
class sro(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sro")
        ...
        self.connect((self.channels_sro_model_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.channels_sro_model_0, 0))
...
def main(top_block_cls=sro, options=None):
