...
class cfo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "cfo")
        ...
        self.connect((self.channels_cfo_model_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.channels_cfo_model_0, 0))
...
def main(top_block_cls=cfo, options=None):
